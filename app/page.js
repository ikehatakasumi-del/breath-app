  ...
  return (
    <div className="text-center md:text-2xl lg:text-lg">
      ...
      <div className="font-medium text-white flex flex-col gap-9 items-center">
        <button className="bg-blue-600 p-4 rounded-4xl w-2xs tracking-wider">GET STARTED</button>
        <button className="bg-blue-600 p-4 rounded-4xl w-2xs tracking-wider">MY PROGRESS</button>
